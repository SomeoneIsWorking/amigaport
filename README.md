...
Only Linux x86-64 has passed outside hosted CI in this milestone. macOS, Windows, and Android remain
unverified until their first hosted jobs complete. An APK install check is inapplicable because this
